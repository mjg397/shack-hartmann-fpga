...
module reciprocal_u16_q16(
  ...
  wire        x1_saturated;
  wire [4:0]  msb_index;
  wire [15:0] denorm_round_bias;
  wire [16:0] denorm_numer;
  wire [16:0] out_q0_16_ext;
  wire        out_sat;
  ...
  assign x0_q0_16 = RECIP_SEED_LUT_Q0_16[16*lut_idx +: 16];

  newton_step_q16 u_newton_step_q16 (
    .a_q1_15(a_q1_15),
    .x0_q0_16(x0_q0_16),
    .x1_q0_16(x1_q0_16),
  ...
  /* De-normalize by msb(v): (x1 + 2^(msb-1)) >> msb with msb in [0, 15]. */
  assign msb_index = 5'd15 - shift_left;
  assign denorm_round_bias = (msb_index == 5'd0) ? 16'h0000 : (16'h0001 << (msb_index - 1'b1));
  assign denorm_numer = {1'b0, x1_q0_16} + {1'b0, denorm_round_bias};
  assign out_q0_16_ext = (msb_index == 5'd0) ? {1'b0, x1_q0_16} : (denorm_numer >> msb_index);

  assign out_sat = (out_q0_16_ext > 17'h0FFFF);
  assign divide_by_zero = v_is_zero;
  assign reciprocal_q16 = v_is_zero ? 16'hFFFF : (out_sat ? 16'hFFFF : out_q0_16_ext[15:0]);

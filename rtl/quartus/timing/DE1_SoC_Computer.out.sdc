...
create_generated_clock -name {clk_25} -source [get_pins {The_System|pll_0|altera_pll_i|general[0].gpll~FRACTIONAL_PLL|refclkin}] -divide_by 4 -multiply_by 1 -master_clock {The_System|system_pll|sys_pll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk} [get_pins {The_System|pll_0|altera_pll_i|outclk_wire[0]~CLKENA0|outclk}] 
...
set_max_delay -from [get_registers {*}] -to [get_registers {*}] 20.000

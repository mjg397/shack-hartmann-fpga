module streaming_emulator #(
  ...
  logic [$clog2(HSIZE)-1:0] line_counter;
  logic [$clog2(VSIZE)-1:0] row_counter;
  logic [$clog2(HBLANK)-1:0] h_blank_counter;
  logic [$clog2(VBLANK)-1:0] v_blank_counter;
...
//  end
  ...
  logic fv_int, lv_int, frame_complete_int;

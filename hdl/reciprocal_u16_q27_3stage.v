...
module reciprocal_u16_q27_3stage(
    input  wire         clk,
    input  wire         reset,
    input  wire [15:0]  v_u16,
    
    output wire [26:0]  reciprocal_q27,
  ...
  wire        x2_saturated;
  wire [4:0]  msb_index;
  wire [26:0] denorm_round_bias;
  wire [27:0] denorm_numer;
  wire [27:0] out_q0_27_ext;
  wire        out_sat;
  ...
  assign v_is_zero = (stg1_v_u16 == 16'h0000);
  assign v_safe = v_is_zero ? 16'h0001 : stg1_v_u16;

  /* Normalize integer input to Q1.15 in [1, 2). */
  assign shift_left = clz16(v_safe);
  assign a_q1_15 = v_safe << shift_left;

  /* Zero-extend to Q1.26 for the 27-bit Newton step. */
  assign a_q1_26 = {a_q1_15, 11'h0000};
  ...
  assign x0_u27 = {seed_q0_16, 11'h0000};

  // END STAGE 1
  // stg2_x0_u27 <= x0_u27
  // STAGE 2 LOGIC
  reg [26:0] stg2_x0_u27;
  reg [26:0] stg2_a_q1_26;
  reg        stg2_v_is_zero;
  reg [4:0]  stg2_shift_left;

  /* First Newton refinement step. */
  newton_step_q27 u_newton_step_0 (
    .a_q1_26(stg2_a_q1_26),
    .x0_u27(stg2_x0_u27),
    .x1_q0_27(x1_q0_27),
  ...
  // END STAGE 2
  // stg3_x1_q0_27 <= x1_q0_27
  // stg3_a_q1_26 <= stg2_a_q1_26
  // STAGE 3 LOGIC
  reg [26:0] stg3_x1_q0_27;
  reg [26:0] stg3_a_q1_26;
  reg        stg3_v_is_zero;
  reg [4:0]  stg3_shift_left;

  /* Second Newton refinement step. */
  newton_step_q27 u_newton_step_1 (
    .a_q1_26(stg3_a_q1_26),
    .x0_u27(stg3_x1_q0_27),
    .x1_q0_27(x2_q0_27),
    .saturated(x2_saturated)
  );

  /* De-normalize: result = x2 >> msb_index (with rounding). */
  assign msb_index = 5'd15 - stg3_shift_left;
  assign denorm_round_bias = (msb_index == 5'd0) ? 27'h0000000 : (27'h0000001 << (msb_index - 1'b1));
  assign denorm_numer = {1'b0, x2_q0_27} + {1'b0, denorm_round_bias};
  assign out_q0_27_ext = (msb_index == 5'd0) ? {1'b0, x2_q0_27} : (denorm_numer >> msb_index);

  assign out_sat = (out_q0_27_ext > 28'h07FFFFFF);
  assign divide_by_zero = stg3_v_is_zero;
  assign reciprocal_q27 = stg3_v_is_zero ? 27'h7FFFFFF : (out_sat ? 27'h7FFFFFF : out_q0_27_ext[26:0]);
  assign saturated = stg3_v_is_zero | out_sat;
  ...
  always @(posedge clk) begin
    if (reset) begin
        ...
        // STAGE 2
        stg2_a_q1_26 <= a_q1_26;
        stg2_x0_u27 <= x0_u27;
        stg2_v_is_zero <= v_is_zero;
        stg2_shift_left <= shift_left;

        // STAGE 3
        stg3_a_q1_26 <= stg2_a_q1_26;
        stg3_x1_q0_27 <= x1_q0_27;
        stg3_v_is_zero <= stg2_v_is_zero;
        stg3_shift_left <= stg2_shift_left;
    end
  end

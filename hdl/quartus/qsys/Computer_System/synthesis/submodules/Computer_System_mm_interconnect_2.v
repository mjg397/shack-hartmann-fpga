...
module Computer_System_mm_interconnect_2 (
		...
		input  wire [31:0] dma_2_write_master_address,                                            //                                              dma_2_write_master.address
		output wire        dma_2_write_master_waitrequest,                                        //                                                                .waitrequest
		input  wire [3:0]  dma_2_write_master_byteenable,                                         //                                                                .byteenable
		input  wire        dma_2_write_master_chipselect,                                         //                                                                .chipselect
		input  wire        dma_2_write_master_write,                                              //                                                                .write
		input  wire [31:0] dma_2_write_master_writedata                                           //                                                                .writedata
	);
	...
	wire   [31:0] dma_1_read_master_translator_avalon_universal_master_0_readdata;       // dma_1_read_master_agent:av_readdata -> dma_1_read_master_translator:uav_readdata
	...
	wire    [3:0] dma_1_read_master_translator_avalon_universal_master_0_byteenable;     // dma_1_read_master_translator:uav_byteenable -> dma_1_read_master_agent:av_byteenable
	...
	wire   [31:0] dma_1_read_master_translator_avalon_universal_master_0_writedata;      // dma_1_read_master_translator:uav_writedata -> dma_1_read_master_agent:av_writedata
	wire    [2:0] dma_1_read_master_translator_avalon_universal_master_0_burstcount;     // dma_1_read_master_translator:uav_burstcount -> dma_1_read_master_agent:av_burstcount
	wire          dma_2_write_master_translator_avalon_universal_master_0_waitrequest;   // dma_2_write_master_agent:av_waitrequest -> dma_2_write_master_translator:uav_waitrequest
	wire   [31:0] dma_2_write_master_translator_avalon_universal_master_0_readdata;      // dma_2_write_master_agent:av_readdata -> dma_2_write_master_translator:uav_readdata
	wire          dma_2_write_master_translator_avalon_universal_master_0_debugaccess;   // dma_2_write_master_translator:uav_debugaccess -> dma_2_write_master_agent:av_debugaccess
	wire   [31:0] dma_2_write_master_translator_avalon_universal_master_0_address;       // dma_2_write_master_translator:uav_address -> dma_2_write_master_agent:av_address
	wire          dma_2_write_master_translator_avalon_universal_master_0_read;          // dma_2_write_master_translator:uav_read -> dma_2_write_master_agent:av_read
	wire    [3:0] dma_2_write_master_translator_avalon_universal_master_0_byteenable;    // dma_2_write_master_translator:uav_byteenable -> dma_2_write_master_agent:av_byteenable
	wire          dma_2_write_master_translator_avalon_universal_master_0_readdatavalid; // dma_2_write_master_agent:av_readdatavalid -> dma_2_write_master_translator:uav_readdatavalid
	wire          dma_2_write_master_translator_avalon_universal_master_0_lock;          // dma_2_write_master_translator:uav_lock -> dma_2_write_master_agent:av_lock
	wire          dma_2_write_master_translator_avalon_universal_master_0_write;         // dma_2_write_master_translator:uav_write -> dma_2_write_master_agent:av_write
	wire   [31:0] dma_2_write_master_translator_avalon_universal_master_0_writedata;     // dma_2_write_master_translator:uav_writedata -> dma_2_write_master_agent:av_writedata
	wire    [2:0] dma_2_write_master_translator_avalon_universal_master_0_burstcount;    // dma_2_write_master_translator:uav_burstcount -> dma_2_write_master_agent:av_burstcount
	wire          rsp_mux_001_src_valid;                                                 // rsp_mux_001:src_valid -> dma_2_write_master_agent:rp_valid
	wire  [117:0] rsp_mux_001_src_data;                                                  // rsp_mux_001:src_data -> dma_2_write_master_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                 // dma_2_write_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                               // rsp_mux_001:src_channel -> dma_2_write_master_agent:rp_channel
	wire          rsp_mux_001_src_startofpacket;                                         // rsp_mux_001:src_startofpacket -> dma_2_write_master_agent:rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                           // rsp_mux_001:src_endofpacket -> dma_2_write_master_agent:rp_endofpacket
	wire          dma_1_read_master_agent_cp_valid;                                      // dma_1_read_master_agent:cp_valid -> router:sink_valid
	wire  [117:0] dma_1_read_master_agent_cp_data;                                       // dma_1_read_master_agent:cp_data -> router:sink_data
	...
	wire          dma_2_write_master_agent_cp_valid;                                     // dma_2_write_master_agent:cp_valid -> router_001:sink_valid
	wire  [117:0] dma_2_write_master_agent_cp_data;                                      // dma_2_write_master_agent:cp_data -> router_001:sink_data
	wire          dma_2_write_master_agent_cp_ready;                                     // router_001:sink_ready -> dma_2_write_master_agent:cp_ready
	wire          dma_2_write_master_agent_cp_startofpacket;                             // dma_2_write_master_agent:cp_startofpacket -> router_001:sink_startofpacket
	wire          dma_2_write_master_agent_cp_endofpacket;                               // dma_2_write_master_agent:cp_endofpacket -> router_001:sink_endofpacket
	...
	wire  [117:0] router_src_data;                                                       // router:src_data -> dma_1_read_master_limiter:cmd_sink_data
	...
	wire  [117:0] dma_1_read_master_limiter_cmd_src_data;                                // dma_1_read_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [117:0] rsp_mux_src_data;                                                      // rsp_mux:src_data -> dma_1_read_master_limiter:rsp_sink_data
	...
	wire  [117:0] dma_1_read_master_limiter_rsp_src_data;                                // dma_1_read_master_limiter:rsp_src_data -> dma_1_read_master_agent:rp_data
	...
	altera_merlin_master_translator #(
		...
		.AV_LINEWRAPBURSTS           (0),
		.AV_REGISTERINCOMINGSIGNALS  (0)
	) dma_2_write_master_translator (
		.clk                    (System_PLL_sys_clk_clk),                                                //                       clk.clk
		.reset                  (dma_1_reset_reset_bridge_in_reset_reset),                               //                     reset.reset
		.uav_address            (dma_2_write_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (dma_2_write_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (dma_2_write_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (dma_2_write_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (dma_2_write_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (dma_2_write_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (dma_2_write_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (dma_2_write_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (dma_2_write_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (dma_2_write_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (dma_2_write_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (dma_2_write_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (dma_2_write_master_waitrequest),                                        //                          .waitrequest
		.av_byteenable          (dma_2_write_master_byteenable),                                         //                          .byteenable
		.av_chipselect          (dma_2_write_master_chipselect),                                         //                          .chipselect
		.av_write               (dma_2_write_master_write),                                              //                          .write
		.av_writedata           (dma_2_write_master_writedata),                                          //                          .writedata
		.av_burstcount          (1'b1),                                                                  //               (terminated)
		.av_beginbursttransfer  (1'b0),                                                                  //               (terminated)
		.av_begintransfer       (1'b0),                                                                  //               (terminated)
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) dma_2_write_master_agent (
		.clk                   (System_PLL_sys_clk_clk),                                                //       clk.clk
		.reset                 (dma_1_reset_reset_bridge_in_reset_reset),                               // clk_reset.reset
		.av_address            (dma_2_write_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (dma_2_write_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (dma_2_write_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (dma_2_write_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (dma_2_write_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (dma_2_write_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (dma_2_write_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (dma_2_write_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (dma_2_write_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (dma_2_write_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (dma_2_write_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (dma_2_write_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (dma_2_write_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (dma_2_write_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (dma_2_write_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (dma_2_write_master_agent_cp_ready),                                     //          .ready
	...
	Computer_System_mm_interconnect_2_router router_001 (
		.sink_ready         (dma_2_write_master_agent_cp_ready),         //      sink.ready
		.sink_valid         (dma_2_write_master_agent_cp_valid),         //          .valid
		.sink_data          (dma_2_write_master_agent_cp_data),          //          .data
		.sink_startofpacket (dma_2_write_master_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (dma_2_write_master_agent_cp_endofpacket),   //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                    //       clk.clk
		.reset              (dma_1_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
	...
	Computer_System_mm_interconnect_2_cmd_demux_001 cmd_demux_001 (
		.clk                (System_PLL_sys_clk_clk),                  //       clk.clk
		.reset              (dma_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Computer_System_mm_interconnect_2_cmd_demux_001 rsp_demux (
		.clk                (System_PLL_sys_clk_clk),                                                //       clk.clk
		.reset              (ARM_A9_HPS_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Computer_System_mm_interconnect_2_cmd_demux_001 rsp_demux_001 (
		.clk                (System_PLL_sys_clk_clk),                                                //       clk.clk
		.reset              (ARM_A9_HPS_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset

...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/Computer_System_mm_interconnect_2_avalon_st_adapter_error_adapter_0.sv \
  ...
  $QSYS_SIMDIR/submodules/Computer_System_mm_interconnect_2_avalon_st_adapter.v \
  ...
  $QSYS_SIMDIR/submodules/Computer_System_mm_interconnect_1_cmd_demux_001.sv \
  ...
  $QSYS_SIMDIR/submodules/Computer_System_dma_2.v \
  $QSYS_SIMDIR/submodules/Computer_System_dma_1.v \
